...
class CityTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $insertQueries = "INSERT INTO `cities` (`id`, `city_name`, `latitude`, `longitude`, `state`) VALUES
...
INSERT INTO `cities` (`id`, `city_name`, `latitude`, `longitude`, `state`) VALUES
...
(1000, 'Rurki', '29.87 N', '77.89 E', 'Uttaranchal');";
        \Illuminate\Support\Facades\DB::raw($insertQueries);
    }
}
